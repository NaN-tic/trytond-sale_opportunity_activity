#!/usr/bin/env python
# This file is part sale_opportunity_activity module for Tryton.
...
setup(name='%s_%s' % (PREFIX, MODULE),
    version=version,
    description='Tryton sale_opportunity_activity Module',
    ...
    convert_2to3_doctests=[
        'tests/scenario_sale_opportunity_activity.rst',
        ],
    )
