...
PREFIX = 'trytonspain'
MODULE2PREFIX = {'activity': 'trytonspain'}
OWNER = {
    'nantic':'NaN-tic',
    'trytonzz':'nanticzz',
}
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-sale_opportunity_activity',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-sale_opportunity_activity'
    },
    classifiers=[
